...
use marinade_finance::{calc::proportional, state::StateHelpers};
...
impl ProcessScoresOptions {
    pub fn process(
        ...
        for v in validator_scores.iter_mut() {
            ...
            // VymD
            // Vote lagging
            if v.vote_address == "8Pep3GmYiijRALqrMKpez92cxvF4YPTzoZg83uXh14pW" {
                v.score = 0
            }
        }
        ...
        // ---------------------------
        info!("PASS 2 - save score as {}", self.result_file);
        {
